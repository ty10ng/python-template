"""
Configuration management module for test_project.
...
class Config:
    """Hierarchical configuration manager for test_project."""
    ...
    def __init__(self, config_file: Optional[str] = None, config_file_env_var: str = 'TEST_PROJECT_CONFIG_FILE'):
        """
    ...
    def _load_environment_overrides(self):
        ...
        env_mappings = {
            ...
            'TEST_PROJECT_LOG_LEVEL': 'logging.level',
            'TEST_PROJECT_CONSOLE_LOG_LEVEL': 'logging.console_level',
            'TEST_PROJECT_FILE_LOG_LEVEL': 'logging.file_level',
            'TEST_PROJECT_LOG_FILE_PATH': 'logging.file_path',
            'TEST_PROJECT_LOG_MAX_FILE_SIZE': 'logging.max_file_size',
            'TEST_PROJECT_LOG_BACKUP_COUNT': 'logging.backup_count',
            ...
            # App configuration
            'TEST_PROJECT_APP_NAME': 'app.name',
            'TEST_PROJECT_APP_VERSION': 'app.version',
            'TEST_PROJECT_DEBUG': 'app.debug'
        }
