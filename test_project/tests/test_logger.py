...
from test_project.logger import (
    get_logger,
    get_audit_logger,
    log_security_event,
    set_log_level,
...
class TestMainLogger:
    ...
    @patch('test_project.logger._test_project_logger')
...
class TestLoggerConfiguration:
    ...
    def test_parse_file_size(self):
        ...
        logger_instance = TestprojectLogger()
    ...
    def test_logger_with_temp_directory(self, temp_dir):
        ...
        with patch.dict('os.environ', {'TEST_PROJECT_LOG_FILE_PATH': str(temp_dir / 'test.log')}):
...
class TestLoggerIntegration:
    ...
    def test_complete_logging_workflow(self, temp_dir):
        ...
        with patch.dict('os.environ', {
            'TEST_PROJECT_LOG_FILE_PATH': str(log_file),
            'TEST_PROJECT_CONSOLE_LOG_LEVEL': 'WARNING',
            'TEST_PROJECT_FILE_LOG_LEVEL': 'DEBUG'
        }):
