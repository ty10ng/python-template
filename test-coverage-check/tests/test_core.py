...
from test_coverage_check.core import App
...
class TestApp:
    ...
    @patch('test_coverage_check.core.load_dotenv')
    ...
    @patch('test_coverage_check.core.App._process_data')
...
"""
    ...
    @patch('test_coverage_check.core.os.getenv')
