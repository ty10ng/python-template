...
from test_coverage_check.logger import (
    get_logger,
    get_audit_logger,
    log_security_event,
    set_log_level,
...
class TestMainLogger:
    ...
    @patch('test_coverage_check.logger.TestcoveragecheckLogger')
...
class TestLoggerConfiguration:
    ...
    def test_parse_file_size(self):
        ...
        logger_instance = TestcoveragecheckLogger()
    ...
    def test_logger_with_temp_directory(self, temp_dir):
        ...
        with patch.dict('os.environ', {'TEST_COVERAGE_CHECK_LOG_FILE_PATH': str(temp_dir / 'test.log')}):
...
class TestLoggerIntegration:
    ...
    def test_complete_logging_workflow(self, temp_dir):
        ...
        with patch.dict('os.environ', {
            'TEST_COVERAGE_CHECK_LOG_FILE_PATH': str(log_file),
            'TEST_COVERAGE_CHECK_CONSOLE_LOG_LEVEL': 'WARNING',
            'TEST_COVERAGE_CHECK_FILE_LOG_LEVEL': 'DEBUG'
        }):
