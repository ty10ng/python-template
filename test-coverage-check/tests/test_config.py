...
# from test_coverage_check.config import Config, get_config
...
class TestConfig:
    ...
    def test_config_initialization(self):
        ...
        from src.test_coverage_check.config import Config
    ...
    def test_get_config_singleton(self):
        ...
        from src.test_coverage_check.config import get_config
