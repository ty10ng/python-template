"""
Core application module for test_coverage_check.
...
class App:
    """Main application class for test_coverage_check."""
    
    def __init__(self):
        """Initialize the test_coverage_check application."""
    ...
    def _check_environment(self):
        ...
        project_root = current_file.parent.parent.parent  # Go up from src/test_coverage_check/core.py to project root
...
def main():
    ...
    logger.info("Starting test_coverage_check application")
