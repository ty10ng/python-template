"""
Configuration management module for test_coverage_check.
...
class Config:
    """Hierarchical configuration manager for test_coverage_check."""
    ...
    def __init__(self, config_file: Optional[str] = None, config_file_env_var: str = 'TEST_COVERAGE_CHECK_CONFIG_FILE'):
        """
    ...
    def _load_environment_overrides(self):
        ...
        env_mappings = {
            ...
            'TEST_COVERAGE_CHECK_LOG_LEVEL': 'logging.level',
            'TEST_COVERAGE_CHECK_CONSOLE_LOG_LEVEL': 'logging.console_level', 
            'TEST_COVERAGE_CHECK_FILE_LOG_LEVEL': 'logging.file_level',
            'TEST_COVERAGE_CHECK_LOG_FILE_PATH': 'logging.file_path',
            'TEST_COVERAGE_CHECK_LOG_MAX_FILE_SIZE': 'logging.max_file_size',
            'TEST_COVERAGE_CHECK_LOG_BACKUP_COUNT': 'logging.backup_count',
            ...
            # App configuration
            'TEST_COVERAGE_CHECK_APP_NAME': 'app.name',
            'TEST_COVERAGE_CHECK_APP_VERSION': 'app.version',
            'TEST_COVERAGE_CHECK_DEBUG': 'app.debug'
        }
