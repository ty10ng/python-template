"""
Configuration management module for cli_coverage_test.
...
class Config:
    """Hierarchical configuration manager for cli_coverage_test."""
    ...
    def __init__(self, config_file: Optional[str] = None, config_file_env_var: str = 'CLI_COVERAGE_TEST_CONFIG_FILE'):
        """
    ...
    def _load_environment_overrides(self):
        ...
        env_mappings = {
            ...
            'CLI_COVERAGE_TEST_LOG_LEVEL': 'logging.level',
            'CLI_COVERAGE_TEST_CONSOLE_LOG_LEVEL': 'logging.console_level', 
            'CLI_COVERAGE_TEST_FILE_LOG_LEVEL': 'logging.file_level',
            'CLI_COVERAGE_TEST_LOG_FILE_PATH': 'logging.file_path',
            'CLI_COVERAGE_TEST_LOG_MAX_FILE_SIZE': 'logging.max_file_size',
            'CLI_COVERAGE_TEST_LOG_BACKUP_COUNT': 'logging.backup_count',
            ...
            # App configuration
            'CLI_COVERAGE_TEST_APP_NAME': 'app.name',
            'CLI_COVERAGE_TEST_APP_VERSION': 'app.version',
            'CLI_COVERAGE_TEST_DEBUG': 'app.debug'
        }
