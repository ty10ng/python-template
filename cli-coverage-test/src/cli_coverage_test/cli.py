"""
Command-line interface for CLI Coverage Test.
...
def status(ctx):
    ...
    table = Table(title="CLI Coverage Test Status")
...
def completion():
    ...
    console.print("    eval \"$(cli-coverage-test --help)\"")
    ...
    console.print("    cli-coverage-test --help | source")
...
def generate_man_page():
    ...
    try:
        ...
        man_file = os.path.join(output_dir, "cli-coverage-test.1")
        print(f"✅ Man page generated: {man_file}")
        print(f"Install with: sudo cp {man_file} /usr/local/man/man1/")
        print(f"View with: man cli-coverage-test")
