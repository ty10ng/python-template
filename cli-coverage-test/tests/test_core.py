...
from cli_coverage_test.core import App
...
class TestApp:
    ...
    @patch('cli_coverage_test.core.load_dotenv')
    ...
    @patch('cli_coverage_test.core.App._process_data')
...
"""
    ...
    @patch('cli_coverage_test.core.os.getenv')
