...
from cli_coverage_test.logger import (
    get_logger,
    get_audit_logger,
    log_security_event,
    set_log_level,
...
class TestMainLogger:
    ...
    @patch('cli_coverage_test.logger.ClicoveragetestLogger')
...
class TestLoggerConfiguration:
    ...
    def test_parse_file_size(self):
        ...
        logger_instance = ClicoveragetestLogger()
    ...
    def test_logger_with_temp_directory(self, temp_dir):
        ...
        with patch.dict('os.environ', {'CLI_COVERAGE_TEST_LOG_FILE_PATH': str(temp_dir / 'test.log')}):
...
class TestLoggerIntegration:
    ...
    def test_complete_logging_workflow(self, temp_dir):
        ...
        with patch.dict('os.environ', {
            'CLI_COVERAGE_TEST_LOG_FILE_PATH': str(log_file),
            'CLI_COVERAGE_TEST_CONSOLE_LOG_LEVEL': 'WARNING',
            'CLI_COVERAGE_TEST_FILE_LOG_LEVEL': 'DEBUG'
        }):
