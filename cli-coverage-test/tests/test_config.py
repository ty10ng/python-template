...
# from cli_coverage_test.config import Config, get_config
...
class TestConfig:
    ...
    def test_config_initialization(self):
        ...
        from src.cli_coverage_test.config import Config
    ...
    def test_get_config_singleton(self):
        ...
        from src.cli_coverage_test.config import get_config
...
"""
    ...
    def test_config_env_variable_type_conversion(self):
        ...
        with patch.dict('os.environ', {
            ...
            'CLI_COVERAGE_TEST_DEBUG': 'true',  # Should convert to bool
            'CLI_COVERAGE_TEST_LOG_MAX_FILE_SIZE': '50MB',  # Should convert to bytes
        }):
            config = Config()
    ...
    def test_config_env_variable_invalid_conversion(self):
        ...
        with patch.dict('os.environ', {
            ...
            'CLI_COVERAGE_TEST_LOG_MAX_FILE_SIZE': 'invalid_size',  # Invalid size
        }):
            config = Config()
